	...
	<form class="form-horizontal" action="" method="POST" role="form">
		<div class="col-lg-4 col-md-6 col-sm-12 col-xs-12">
			...
			<div class="form-group">
				...
				<div class="controls">
					<input class="form-control" name="data[api_pde]" type="text" id="inputApiPde" value="<?php echo $product->api_pde?>">
				</div>
			</div>
			<div class="form-group">
				<label class="control-label" for="inputCompanyPde">Company PDE</label>
				<div class="controls">
					<input class="form-control" name="data[company_pde]" type="text" id="inputCompanyPde" value="<?php echo $product->company_pde?>">
				</div>
			</div>
			<div class="form-group">
				<label class="control-label" for="inputName">Product Name</label>
				<div class="controls">
					<input class="form-control" name="data[name]" type="text" id="inputName" value="<?php echo $product->title?>" placeholder="Product name">
				</div>
			</div>
			<div class="form-group">
				<label class="control-label" for="inputPrice">Base Price</label>
				<div class="controls">
					<input class="form-control" name="data[price]" type="text" id="inputPrice" placeholder="14.32" value="<?php echo $product->price?>">
				</div>
			</div>
		</div>
		<div class="col-lg-5 col-lg-offset-1 col-md-6 col-sm-12 col-xs-12">
			<div class="form-group">
				<div id="photo" class="">
		            ...
		            <a class="thumbnail" href="#"><img class="img-rounded" src="/public/products/<?php echo $product->photo?>"/></a>
	        	</div>
			</div>
		</div>
		<div class="col-lg-12">
